<template>
  <div class="container">
    ...
    <div class="content">
      <div style="margin-top:5rem;background:#fff;border-bottom:1px solid #e5e5e5">
        <div class="markimg">
        ...
        <div class="right">
          ...
          <div title="国际分类"@click="gototypeDetails(goodList.intClsId)"><b>国际分类：</b><span style="color:#9329DB;">{{goodList.intCls}}</span></div>
        </div>
      ...
      <group>
        ...
        <cell title="优先权日期" :value="value">
          <span v-for="date in goodList.priorityDate">{{date}}</span>
         </cell>
        <cell title="是否共有商标" :value="value">{{goodList.ifShareTm}}</cell>
      </group>
    </div>
